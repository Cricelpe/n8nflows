...
# Vuelve al usuario 'node', recomendado para ejecutar la aplicacion de forma segura
USER node

# Declara /data como un volumen persistente
# Esto permite conservar la informacion de n8n (flujos, credenciales, etc.) fuera del contenedor
VOLUME /data
